...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><msg:message code="accounts.page.title" /></h1>
			</div>
		</div>
		<!--/.row-->
		<!--/Title in the page-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><msg:message code="accounts.manager" /></div>
					<div class="panel-body">

						<sf:form method="POST" commandName="accounts" role="form">
							<div class="form-group">
								<label><msg:message code="account.name" /></label>
								<sf:input path="name" class="form-control"
									placeholder=<msg:message code="account.name" /> />
							</div>

							<div class="form-group">
								<label><msg:message code="institution.name" /></label>
								<sf:input path="institution" class="form-control"
									placeholder="<msg:message code="institution.name" />" />
							</div>
							
							<div class="form-group">
								<label><msg:message code="balance" /></label>
								<sf:input path="balance" class="form-control"
									placeholder="<msg:message code="balance" />" type="number" />
							</div>
