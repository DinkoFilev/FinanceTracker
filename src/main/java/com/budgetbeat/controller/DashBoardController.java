		...
		for (Transaction transaction : tran) {
			if (transaction.getFt_account_id() == 3) {
				if (transaction.getDate().after(Date.valueOf("2016-01-01"))
					...
					graph.get(0).setValue(String.valueOf(Double.parseDouble(graph.get(0).getValue()) + (double) (transaction.getAmount() * -1)));
					}else{
						graph.get(0).setValue2(String.valueOf(Double.parseDouble(graph.get(0).getValue2()) +  (double) transaction.getAmount()));
					}
				}
				if (transaction.getDate().after(Date.valueOf("2016-02-01"))
					...
					if(!transaction.getIncome()){
						System.out.println(transaction.getAmount());
					graph.get(1).setValue(String.valueOf(Double.parseDouble(graph.get(1).getValue()) + (double) (transaction.getAmount() * -1)));
					}else{
						graph.get(1).setValue2(String.valueOf(Double.parseDouble(graph.get(1).getValue2()) +  (double)transaction.getAmount()));
					}
				}
				if (transaction.getDate().after(Date.valueOf("2016-03-01"))
					...
					if(!transaction.getIncome()){
						System.out.println(transaction.getAmount());
					graph.get(2).setValue(String.valueOf(Double.parseDouble(graph.get(2).getValue()) + (double) (transaction.getAmount() * -1)));
					}else{
						graph.get(2).setValue2(String.valueOf(Double.parseDouble(graph.get(2).getValue2()) +  (double)transaction.getAmount()));
					}
				}
				if (transaction.getDate().after(Date.valueOf("2016-04-01"))
					...
					if(!transaction.getIncome()){
						System.out.println(transaction.getAmount());
					graph.get(3).setValue(String.valueOf(Double.parseDouble(graph.get(3).getValue()) + (double) (transaction.getAmount() * -1)));
					}else{
						graph.get(3).setValue2(String.valueOf(Double.parseDouble(graph.get(3).getValue2()) + (double) transaction.getAmount()));
					}
				}
				if (transaction.getDate().after(Date.valueOf("2016-05-01"))
					...
					if(!transaction.getIncome()){
						System.out.println(transaction.getAmount());
					graph.get(4).setValue(String.valueOf(Double.parseDouble(graph.get(4).getValue()) + (double) (transaction.getAmount() * -1)));
					}else{
						graph.get(4).setValue2(String.valueOf(Double.parseDouble(graph.get(4).getValue2()) +  (double)transaction.getAmount()));
					}
				}
				if (transaction.getDate().after(Date.valueOf("2016-06-01"))
					...
					if(!transaction.getIncome()){
						System.out.println(transaction.getAmount());
					graph.get(5).setValue(String.valueOf(Double.parseDouble(graph.get(5).getValue()) + (double) (transaction.getAmount() * -1)));
					}else{
						graph.get(5).setValue2(String.valueOf(Double.parseDouble(graph.get(5).getValue2()) +  (double)transaction.getAmount()));
					}
				}
				if (transaction.getDate().after(Date.valueOf("2016-07-01"))
					...
					if(!transaction.getIncome()){
						System.out.println(transaction.getAmount());
					graph.get(6).setValue(String.valueOf(Double.parseDouble(graph.get(6).getValue()) + (double) (transaction.getAmount() * -1)));
					}else{
						graph.get(6).setValue2(String.valueOf(Double.parseDouble(graph.get(6).getValue2()) + (double) transaction.getAmount()));
					}
				}
				if (transaction.getDate().after(Date.valueOf("2016-08-01"))
					...
					if(!transaction.getIncome()){
						System.out.println(transaction.getAmount());
					graph.get(7).setValue(String.valueOf(Double.parseDouble(graph.get(7).getValue()) + (double)(transaction.getAmount() * -1)));
					}else{
						graph.get(7).setValue2(String.valueOf(Double.parseDouble(graph.get(7).getValue2()) +  (double)transaction.getAmount()));
					}
				}
				if (transaction.getDate().after(Date.valueOf("2016-09-01"))
					...
					if(!transaction.getIncome()){
						System.out.println(transaction.getAmount());
					graph.get(8).setValue(String.valueOf(Double.parseDouble(graph.get(8).getValue()) + (double) (transaction.getAmount() * -1)));
					}else{
						graph.get(8).setValue2(String.valueOf(Double.parseDouble(graph.get(8).getValue2()) + transaction.getAmount()));
					}
				}
				if (transaction.getDate().after(Date.valueOf("2016-10-01"))
					...
					if(!transaction.getIncome()){
						System.out.println(transaction.getAmount());
					graph.get(9).setValue(String.valueOf(Double.parseDouble(graph.get(9).getValue()) + (double) (transaction.getAmount() * -1)));
					}else{
						graph.get(9).setValue2(String.valueOf(Double.parseDouble(graph.get(9).getValue2()) + (double) transaction.getAmount()));
					}
				}
				if (transaction.getDate().after(Date.valueOf("2016-11-01"))
					...
					if(!transaction.getIncome()){
						System.out.println(transaction.getAmount());
					graph.get(10).setValue(String.valueOf(Double.parseDouble(graph.get(10).getValue()) + (double) (transaction.getAmount() * -1)));
					}else{
						graph.get(10).setValue2(String.valueOf(Double.parseDouble(graph.get(10).getValue2()) + (double)transaction.getAmount()));
					}
				}
				if (transaction.getDate().after(Date.valueOf("2016-12-01"))
					...
					if(!transaction.getIncome()){
						System.out.println(transaction.getAmount());
					graph.get(11).setValue(String.valueOf(Double.parseDouble(graph.get(11).getValue()) + (double)(transaction.getAmount())));
					}else{
						graph.get(11).setValue2(String.valueOf(Double.parseDouble(graph.get(11).getValue2()) + (double)transaction.getAmount()));
					}
				}
